...
define('_MD_SCS_STU_ID', '學生編號');
define('_MD_SCS_CONSULT_DATE', '諮商日期');
define('_MD_SCS_CONSULT_START', '開始時間');
define('_MD_SCS_CONSULT_END', '結束時間');
...
define('_MD_SCS_UP_CONSULT_ID', '上傳');
define('_MD_SCS_SHOW_CONSULT_ID_FILES', '上傳');
